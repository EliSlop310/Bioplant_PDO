...
<body bgcolor=#45B39D><main>
    ...
    <img   src="<?php echo RUTA_URL?>img/LogoBioPlant.jpg" height="150px" width="250px"/>
     ...
     <form id="regis" action="<?php echo RUTA_URL;?>/admin/ConfirmP" method="POST" enctype="multipart/form-data">
        Foto:<br/><input id="foto" type="file" REQUIRED name="Foto"/><br><br>
        Nombre:<br/><input id="nombre" type="text" REQUIRED name="Nombre" placeholder="Rosal rojo..." value=""/><br><br>
        Cantidad:<br/><input id="cant" type="text" REQUIRED name="Cantidad" placeholder="60,90,20,100...etc" value=""/><br><br>
        Categoria: <br/><input id="categ" type="text" REQUIRED list="cate" name="Categoria" placeholder="Elije una opcion..."/><br><br>
         ...
         Precio unitario:<br/><input id="precio" type="text" REQUIRED name="PrecioU" placeholder="$..." value=""/><br><br>
